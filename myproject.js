    ...
    cardElement[i].addEventListener("click", () => {
      backLayerDetail.innerHTML = `<div class="containerDetail">
                ...
                <div class="containerDetailContent">
                    <h2>${myProject[i].name}</h2>
                    <div class="propertiesDetail">
                        <div class="imageDetail" style="background-image: url(${
                          myProject[i].image
                        });"></div>
                        <div class="textDetail">
                            <div class="durationDetail">
                                ...
                                <div class="durationDate">
                                    <span class="iconDate"></span><span>${formatTanggal(
                                      myProject[i].startDate
                                    )} - ${formatTanggal(
        myProject[i].endDate
      )}</span>
                                </div>
                                <div class="durationCount">
                                    <span class="iconDuration"></span>
                                    <span>${countDuration(
                                      myProject[i].startDate,
                                      myProject[i].endDate
                                    )}</span>
